<header x-data="{mobileMenuOpen: false}" class="flex justify-between bg-slate-800 shadow-md text-white">
    <div>
        <a href="<?php echo e(route('home')); ?>" class="block py-navbar-item pl-5"> Logo </a>
    </div>
    <!-- Responsive Menu -->
    <div class="block fixed z-10 top-0 bottom-0 height h-full w-[220px] transition-all bg-slate-900 md:hidden"
        ...
        <ul>
            ...
            <?php else: ?>
                <li>
                    <a href="<?php echo e(route('login')); ?>" class="flex items-center py-2 px-3 transition-colors hover:bg-slate-800">
...
</header><?php /**PATH C:\Users\62812\Documents\LARAVEL FUNDAMENTAL\laravel vue ecommerce\ecommerce\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>